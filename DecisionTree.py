# -*- coding: utf-8 -*-
"""
Created on Fri Mar 29 17:25:28 2019
...
for i in depths:
    ...
    roc_auc = roc_auc_score(y_train, dtc.predict(x_train))
...
plt.plot(depths, trainingScoreRocAuc, 'g', label = 'roc auc score on training set')
plt.plot(depths, testingScoreRocAuc, 'magenta', label = 'roc auc score on testing set')
plt.legend()
plt.ylabel('score')
